...
OTE, OTL, OTU, MOV, TON, RTO, RES, CTU, and CTD only when a record matches a controlled
...
TON and RTO report timer, time base, preset, and accumulator. Unknown or differently
