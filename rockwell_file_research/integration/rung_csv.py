...
FIELDNAMES: list[str] = [
    ...
    "distinct_matched_operand_count",
...
def _row(
    ...
    *,
    ...
    return {
        ...
        "rung_byte_length": usage["rung_byte_length"],
        "rung_sha256": "" if omit_hashes else usage["rung_sha256"] or "",
        "rung_operand_count": usage["rung_operand_count"],
        "rung_direct_operand_count": usage["rung_direct_operand_count"],
        "rung_indirect_operand_count": usage["rung_indirect_operand_count"],
        "binding_count": usage["binding_count"],
        "operand_occurrence_count": usage["operand_occurrence_count"],
        "distinct_matched_operand_count": usage["distinct_matched_operand_count"],
