...
def build_synthetic_ccw_workbook(
    ...
    *,
    ...
    sheet1: dict[int, dict[str, str]] = {
        ...
        11: {"L": "Min", "O": "Max", "V": "Min", "W": "Max", "X": "Min", "Y": "Max"},
    }
    ...
    sheet2 = {
        6: {"M": "SCREEN REPORT"},
        8: {"B": "Name", "G": "Number", "L": "Description", "U": "Rights"},
    ...
    sheet7 = {
        ...
        16: {
            ...
            "F": "Address",
            "H": "Description",
            "L": "Response Timeout Milliseconds",
            "P": "Fail After",
            "R": "Connection Timeout Seconds",
            "T": "Inter Request Delay Milliseconds",
        },
        17: {
            "B": "SyntheticPLC",
            "C": "MicroLogix 1400",
